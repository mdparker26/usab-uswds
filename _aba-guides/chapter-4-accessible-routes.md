...
[[§F206.2.3]({{ site.baseurl }}/aba/#aba-f206_2_3)]
...
![Two story facility with a small upper story with a maximum occupancy of five.  Caption:  Exception: Two story government facilities where the story above (or below) entry level has no public use space and a maximum occupant load of 5.]({{ site.baseurl }}{{ page.image-directory }}chapter4/4ar10ab.jpg){: .img-large}
...
![Facility with mezzanine.  Caption:  Exception:  Mezzanines in single-story facilities and facilities where an accessible route between stories is not required.  Restaurant/ cafeteria symbol with note:  In restaurants and cafeterias, this exception applies only where a mezzanine contains less than 25% of the combined dining and seating area and equivalent services and décor are provided on an accessible level (§206.2.5, Ex. 1).]({{ site.baseurl }}{{ page.image-directory }}chapter4/4ar12ab.jpg){: .img-large}
...
<div style="margin-top: 10px; padding-top: 10px;" class="border">
    ...
    <p>An accessible route must connect stages and other performance areas directly to seating areas where they are directly connected by a circulation path as well as to dressing rooms and other ancillary spaces used by performers (§F206.2.6).</p>
</div>

### Press Boxes

[[§F206.2.7]({{ site.baseurl }}/aba/#aba-f206_2_7)]
